import * as dao from './users-bronze-dao.js';

const BronzeUserController = (app) => {
    ...
    app.post('/bronze-users', createUser)
    app.get('/bronze-users', findAllUsers)
    app.delete('/bronze-users/:uid', deleteUser)
    app.put('/bronze-user', updateUser)
    app.get('/welcome-recent-new-users',welcomeRecentNewUsers)
    app.post('/bronze-register', register)
    app.post('/login', login)
    app.post('/profile', profile)
    app.post('/logout', logout)
}

export default BronzeUserController